      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <div className="flex items-center gap-2 mb-3">
            <img src="/assets/logo.webp" alt="Wear Out" className="h-12 w-auto" />
          </div>
          <p className="text-slate-600 text-sm font-medium">Wear Your Confidence. Premium streetwear, built to stand out.</p>
        </div>
